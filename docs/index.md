...
An application built from https://github.com/fpetk-rolling-demo/crew-ai-test25092501 will be stored in [quay.io/tpetkos/crew-ai-test25092501](https://quay.io/tpetkos/crew-ai-test25092501) and deployed through GitOps. This application is accessible on port **8501\*\*.
